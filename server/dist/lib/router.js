...
router.get("/post/:id", post_controller_1.post_get);
router.post("/post/:id/delete", authMiddleware_1.default, post_controller_1.post_delete);
router.post("/post/:id/comment", comment_controller_1.comment_create);
router.get("/comments", comment_controller_1.test_comments_get);
router.get("/comments/:postId", comment_controller_1.comments_get);
router.post("/comment/:id/delete", comment_controller_1.comment_delete);
